...
ПРАВИЛА:
- В первую очередь используй места из предоставленного списка
- Если какого-то места нет в списке но ты абсолютно уверен в его существовании, адресе и актуальности — можешь добавить его. Но только если уверен на 100%. Если есть хоть малейшее сомнение — не добавляй.
