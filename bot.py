...
CATEGORY_KEYWORDS = {
    ...
    "Активность": ["квест", "боулинг", "бильярд", "картинг", "батут", "активност", "развлечен", "поиграть", "аттракцион"],
    "Культура": ["музей", "галерея", "театр", "выставк", "кино", "культур", "искусств", "спектакл"],
    "Баня/Спа": ["баня", "сауна", "спа", "spa", "расслабит", "отдохнут"],
}
...
- Рейтинг и часы работы — обязательно для каждого места если они есть в данных
...
- Если просят другие варианты — давай новые места, не повторяй уже показанные
- Если указан бюджет — учитывай при выборе, предупреди что точных данных о чеке нет
- Учитывай день недели и время при выборе — клубы работают в основном пт-сб, некоторые места закрыты рано

КАТЕГОРИИ которые можешь предлагать:
Ресторан, Кафе, Бар, Кофейня, Кондитерская, Клуб, Антикафе, Активность (квесты/боулинг/картинг), Культура (музеи/театры/галереи), Баня/Спа
